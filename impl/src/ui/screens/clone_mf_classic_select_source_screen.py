...
class CloneMFClassicSelectSourceScreen(BaseScreen):
    ...
    def load_from_files(self):
        self.filenames = self.file_handler.get_card_dumps(self.settings)
        self.buttons = []
    ...
    def select_file(self, filename):
        ...
        self.logger.log(f"Selected {filename} from {self.settings} files list as a source dump.", level=logging.INFO)
