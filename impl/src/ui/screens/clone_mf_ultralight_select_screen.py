...
class CloneMFUltralightSelectScreen(BaseScreen):
    ...
    def setup_content(self):
        self.description_label = Description("Select MF Ultralight card:")
    ...
    def select_file(self, filename):
        ...
        self.logger.log(f"Selected {filename} from {constants.MF_ULTRALIGHT} files list.", level=logging.INFO)
