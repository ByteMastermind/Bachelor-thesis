"""
Following code is under MIT license - see LICENSE file

The original GitHub repository is at: https://github.com/yjg30737/pyqt-toast/tree/main (accessed 21. 4. 2024)
