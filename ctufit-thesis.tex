...
\ctufitabstractCZE{Tato práce je zaměřena na problematiku bezpečnosti RFID a NFC čipů a karet v infrastruktuře.}
...
\includepdf[pages={1-}]{benesm41-assignment.pdf} % replace that file with your thesis assignment provided by study office
...
\begin{acknowledgmentpage}
	I would like to express my highest gratitude to Mr. Jan Fesl for his guidance as my supervisor, to school 3D laboratory for letting me use the 3D printer and especially to my family and friends for their support.
